...
Java_com_ideacarry_example10_GLRenderer_surfaceCreated(JNIEnv *env, jobject thiz, jobject context, jint color) {
    color = 0xff808000;
    ...
    char *vertexShaderCode = (char *) readAssetFile(env, context, "example10/vertex.glsl", true, nullptr);
    char *fragmentShaderCode = (char *) readAssetFile(env, context, "example10/fragment.glsl", true,
                                                      nullptr);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ideacarry_example10_GLRenderer_surfaceChanged(JNIEnv *env, jobject thiz, jint width, jint height) {
    sWidth = width;
    sHeight = height;
...
extern "C"
JNIEXPORT void JNICALL
Java_com_ideacarry_example10_GLRenderer_drawFrame(JNIEnv *env, jobject thiz) {
